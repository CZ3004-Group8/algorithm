...
class ReedsSheppPath(object):
    ...
    def LmSmLm(self, x, y, phi):
        ...
        if path:
            d, [t, u, v] = list(zip(*path))
            return list(zip(d, [-t, -u, -v]))
        return []
    ...
    def RpSpRp(self, x, y, phi):
        ...
        path = self.LpSpLp(x, -y, -phi)
        if path:
            _, [t, u, v] = list(zip(*path))
            return list(zip(['r', 's', 'r'], [t, u, v]))
        return []
    ...
    def LmRmLpRp(self, x, y, phi):
        ...
        if path:
            d, [t, u, u1, v] = list(zip(*path))
            return list(zip(d, [-t, -u, -u1, -v]))
        return []
    ...
    def RpLpRmLm(self, x, y, phi):
        ...
        path = self.LpRpLmRm(x, -y, -phi)
        if path:
            _, [t, u, u1, v] = list(zip(*path))
            return list(zip(['r', 'l', 'r', 'l'], [t, u, u1, v]))
        return []
    ...
    def RpLmSmRm(self, x, y, phi):
        ...
        if path:
            _, [t, u, u1, v] = list(zip(*path))
            return list(zip(['r', 'l', 's', 'r'], [t, u, u1, v]))
        return []
    ...
    def RpLmSmLm(self, x, y, phi):
        ...
        if path:
            _, [t, u, u1, v] = list(zip(*path))
            return list(zip(['r', 'l', 's', 'l'], [t, u, u1, v]))
        return []
    ...
    def CCSC(self, x, y, phi):
        ...
        for planner in planners:
            path = planner(xb, yb, phi)
            if path:
                [d1, d2, d3, d4], [t, u, u1, v] = list(zip(*path))
                path = list(zip([d4, d3, d2, d1], [v, u1, u, t]))
                paths.append(path)
        return paths
    ...
    def LmRpSpLpRm(self, x, y, phi):
        ...
        if path:
            d, [t, u, u1, u2, v] = list(zip(*path))
            return list(zip(d, [-t, -u, -u1, -u2, -v]))
        return []
    ...
    def RmLpSpRpLm(self, x, y, phi):
        ...
        path = self.LpRmSmLmRp(x, -y, -phi)
        if path:
            _, [t, u, u1, u2, v] = list(zip(*path))
            return list(zip(['r', 'l', 's', 'r', 'l'], [t, u, u1, u2, v]))
        return []
